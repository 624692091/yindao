    ...
    function getTpl() {
        ...
        const xf_site = {
            siteInfo: [
                ...
                { name: '我绝对自信', links: 'https://0ix.cc', pic: 'assets/upload/music_picture.jpg' },
                { name: '丸安导航网', links: 'https://web.0ix.cc/', pic: 'assets/upload/x_picture.jpg' },
        ...
        const xf_friend = {
            friendInfo: [
                { qq: '3528767669', links: 'JavaScript:;', name: '小恺', sig: 'Hello World' },
                { qq: '1292779898', links: 'JavaScript:;', name: '小诗', sig: 'Hello World' },
            ]
        }
